...
/ -------------------------------------------------------------------------------- */
/*
  Replace colours by changing the code. 
  You can add hexadecimal, rgb() and rgba() notation: 
  - hexa code: 	#FFFFFF
  - rgb code: 		rgb(255,255,255)
  - rgba code:		rgba(255,255,255,0.8)
 */
$maincolor= '#0083A2'; 			   				// default value: #0083A2
$topmenu_hover= '#2EA2CC';	   			// default value: #2EA2CC
$backgroundmenu= '#333333'; 				// default value: #333333		//  for left and top menu
$backgroundmenu_hover= '#444444';  // default value: #444444		//  for left and top menu
$backgroundotherbox= '#E6E6E6';       // default value: #E6E6E6		//  Other information boxes on home page  
$backgroundbutton_hover= '#197489'; // default value: #197489						
...
.tmenu a:hover { color:<?php print $maincolor; ?>;}
...
.button:hover   {
	background-color: <?php print $backgroundbutton_hover; ?>; 
    border-color: <?php print $maincolor; ?>;
    -webkit-box-shadow: inset 0 1px 0 rgba(235,235,235,.6);
    box-shadow: inset 0 1px 0 rgba(235,235,235,.6);
    color: #fff;
...
.boxstats {
    ...
    margin: 3px 5px;
    padding: 2px 10px;
    border: 1px dashed <?php print $maincolor; ?>;
    text-align: center;
}
...
#tmenu_tooltip {
    ...
    z-index: 10;
    margin:0;
    background-color: <?php print $backgroundmenu; ?>; 
...
#tmenu_tooltip ul li:hover {
    background-color: <?php print $backgroundmenu_hover; ?>;
...
#tmenu_tooltip ul li > div.menu_contenu1 a:hover { color: <?php print $topmenu_hover; ?>; }
...
#tmenu_tooltip ul li > div.menu_contenu2 a:hover { color:  <?php print $topmenu_hover; ?>; }
...
div.blockvmenubookmarks a.vsmenu:hover { color: <?php print $maincolor; ?>; }
...
tr.box_titre {
    background-color: <?php print $backgroundotherbox; ?>;
    color: #222;
